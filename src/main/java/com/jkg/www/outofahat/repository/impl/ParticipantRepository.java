...
public class ParticipantRepository implements IParticipantRepository {
    ...
    @Autowired
    public ParticipantRepository(IOutOfAHatInfoConnector outOfAHatInfoConnector,
    ...
    @Override
    public String createParticipant(String userId, NewParticipantRequest newRequest) {
